    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2 style="margin-left: 30px;">Create New User</h2>
                </div>
        ...
        <div class="row">
            <div class="card-create">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong class="form-label">Confirm Password:</strong>
                        <span class="required"> * </span>
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        !!}
                        <img src="{{asset('assets/images/users/profile.png')}}" alt="image" id="img-preview"
                            width="150px">
                    </div>
                </div> --}}
